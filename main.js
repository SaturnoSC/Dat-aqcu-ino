    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            if (AMBIENTE == 'producao') {
                ...
                sqlquery = `INSERT INTO [dbo].[Medida] (DHT11_Temperatura, DHT11_Umidade, DataHora, fkSetor, fkSetor_Plantacao) VALUES (${dht11Temperatura}, ${dht11Umidade}, CURRENT_TIMESTAMP, 1, 7)`;

                // CREDENCIAIS DO BANCO REMOTO - SQL SERVER
                // Importante! você deve ter criado o usuário abaixo com os comandos presentes no arquivo
                // "script-criacao-usuario-sqlserver.sql", presente neste diretório.
                const connStr = "Server=svr-projeto-saturnosc.database.windows.net;Database=Satruno SC;User Id=admin-projeto-teste;Password=#Gfgrupo2;";
